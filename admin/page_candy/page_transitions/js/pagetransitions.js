var PageTransitions = (function() {
	...
	function init() {
        ...
        $("#transBtn1").on('click',function(){
            ...
            animcursor=1;
        	var goptions=function(){
        		var showPage=0;
        		var animation=2;
        	}
        	goptions.animation=animcursor;
        	nextPage(goptions);
        	++animcursor;
        });
        $("#transBtn2").on('click',function(){
            if( isAnimating ) {
                return false;
            }
            /*
	...
	function gogo(options,currPageId,nextPageId) {
		...
		var $currPage=$pages.eq(current);//$("."+currPageId);
		var $nextPage=$("."+nextPageId).addClass('pt-page-current');
