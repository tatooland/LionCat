...
require_once("include/layouts.php");

define("FRONT_SITE","yourWebsiteName");

define("BOOT_DIR","yourRootPath");

define("WEBSITE","yourWebsiteName/admin");
...
define('DIR_IMAGE',BOOT_DIR.FRONT_SITE."/wx_assets/img/");
define('DIR_UPLOAD_DIR',BOOT_DIR.WEBSITE."/");

define("HTTP_SERVER","http://localhost");
define('SERVER_DIR_IMAGE',HTTP_SERVER."/".WEBSITE."/wx_assets/img/");
define('IMG_PREFIX_URL',HTTP_SERVER."/".FRONT_SITE."/wx_assets/img/");
