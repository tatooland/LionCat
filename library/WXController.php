...
class WXController extends Controller{
	...
	public function loadWxPayPlugin($figure,$price,$productDesc,$productId){
		require_once('wxlib/wxpay/WxPayPubHelper.php');
		$openId=$this->wx->openId;
		$unifiedOrder=new UnifiedOrder_pub();

		$unifiedOrder->setParameter('openid',"$openId");
		$unifiedOrder->setParameter('body',"$productDesc");
		$timeStamp=time();
		$out_trade_no=$figure.WxPayConf_pub::APPID."$timeStamp";//
		$unifiedOrder->setParameter("out_trade_no","$out_trade_no");
		$mPrice=strval($price*100);
		$unifiedOrder->setParameter("total_fee",$mPrice);//
		$unifiedOrder->setParameter('notify_url',WxPayConf_pub::NOTIFY_URL);//
		$unifiedOrder->setParameter('trade_type','JSAPI');
		$unifiedOrder->setParameter('product_id',"$productId");//
		...
		$data['openId']=$this->wx->openId;
		$data['orderNumber']=$out_trade_no;
		return $this->load->view('common/wx/wxpay.tpl',$data);
	}
